...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/6uFvc2rgk6)
...
```sh
npx nx serve trade-wise-frontend
```

To create a production bundle:

```sh
npx nx build trade-wise-frontend
```

To see all available targets to run for a project, run:

```sh
npx nx show project trade-wise-frontend
```
